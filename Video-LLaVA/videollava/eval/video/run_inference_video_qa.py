...
def parse_args():
    ...
    parser.add_argument('--gt_question_answer', help='Path to the ground truth file containing question.', required=True)
...
def run_inference(args):
    ...
    gt_questions = json.load(open(args.gt_question_answer, "r"))
    ...
    for sample in tqdm(gt_questions):
        ...
        # sample_set = {'id': sample['id'], 'question': question, 'answer': answer}
