...
class EvalDataset(torch.utils.data.IterableDataset):
    ...
    def __init__(
        ...
        data_list = {
            "count": ("json/4_count.json", f"videos/4_count", "video"),
            "ego": ("json/3_ego.json", f"videos/3_ego", "video"),
            "needle": ("json/2_needle.json", f"videos/2_needle", "video"),
            "order": ("json/5_order.json", f"videos/5_order", "video"),
            "plotQA": ("json/1_plotQA.json", f"videos/1_plotQA", "video"),
            "anomaly_reco": (
                "json/6_anomaly_reco.json",
                f"videos/6_anomaly_reco",
                "video",
            ),
            "topic_reasoning": (
                "json/7_topic_reasoning.json",
                f"videos/7_topic_reasoning",
                "video",
            ),
        }
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', default="ood/mlvu")
